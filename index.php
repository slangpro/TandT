  ...
  <footer id="myFooter">
	...
	<img  src="https://www.indianholiday.com/images/footerbg.jpg" width="95%"  alt="" class="img-responsive">
      ...
      <p align="left" class="footerfont" style="margin-left:30px">
        <h3 style="margin-left:30px"><i>Tour And Travel Project</i></h3>
		
		<p style="margin-left:30px"><strong>By</strong> <strong>BRIJESH VISHWAKARMA</strong><br><strong>BIPIN NAVIK</strong></p>
		<p style="margin-left:30px">Chembur, Mumbai</p>
		<p style="margin-left:30px">Phone: +91-8976437641 </p>
			   <p style="margin-left:80px">+91-9768524504</p>
      </p>
